...
export interface ApiComponentComponent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['Hero', 'Services', 'Testimonials', 'PricingTable']
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiTenantTenant extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID & Schema.Attribute.Required;
    theme_configuration: Schema.Attribute.Relation<
      'oneToOne',
      'api::theme-configuration.theme-configuration'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiThemeConfigurationThemeConfiguration
  extends Struct.CollectionTypeSchema {
  collectionName: 'theme_configurations';
  info: {
    displayName: 'Theme Configuration';
    pluralName: 'theme-configurations';
    singularName: 'theme-configuration';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::theme-configuration.theme-configuration': ApiThemeConfigurationThemeConfiguration;
